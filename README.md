...
<img src="http://img.shields.io/static/v1?label=realize%20data&message=Jun&color=yellow&style=for-the-badge" />

</P>

# Formulario com React

Este projeto é uma aplicação React que utiliza o React para criar diferentes tipos de formulario e listadando cada item, podendo ordenar pelo nome de modo crescente ou decrecente.
